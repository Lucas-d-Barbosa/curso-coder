...
<div class="modulo laranja">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=db&file=inserir_1">Inserir Registro #01</a>
            </li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=funcoes&file=funcoes_escopo">Funções e Escopo</a>
            </li>

            <li>
                <a href="exercicio.php?dir=funcoes&file=args_retorno">Argumentos e Retornos</a>
            </li>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=while_dowhile">While & Do While</a>
            </li>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=variaveis&file=valor_x_referencia">Valor x Referência</a>
            </li>
            <li>
