...
<form action="#" method="post">
    <div class="form-row">
        <div class="form-group col-md-8">
            ...
            <input type="text" 
            class="form-control <?= $erros['nome'] ? 'is-invalid' : ''?>" id="nome" 
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" 
            class="form-control <?= $erros['nascimento'] ? 'is-invalid' : ''?>" id="nascimento" 
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" 
            class="form-control <?= $erros['email'] ? 'is-invalid' : ''?>" id="email" 
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" 
            class="form-control  <?= $erros['site'] ? 'is-invalid' : ''?>" id="site" 
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" 
            class="form-control  <?= $erros['filhos'] ? 'is-invalid' : ''?>" id="filhos" 
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" 
            class="form-control  <?= $erros['salario'] ? 'is-invalid' : ''?>" id="salario" 
